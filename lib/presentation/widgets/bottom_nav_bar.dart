...
import 'package:hospitalmanagementuser/presentation/pages/chat/chat_list/chats_list_screen.dart';
...
class BottomNavBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        // BlocProvider(
        //   create: (context) => AppointmentBloc()..add(FetchAppointmentsEvent()),
        // ),
        BlocProvider(
